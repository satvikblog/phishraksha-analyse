...
interface ChannelResultsDashboardProps {
...
export function ChannelResultsDashboard({
  result,
  title,
  subtitle,
  contextEyebrow,
  ...
  return (
    <div className="space-y-6">
      <GlassCard className="panel-sheen overflow-hidden px-5 py-6 sm:px-8 sm:py-8">
        ...
        <div className="relative space-y-8">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <p
                  className={cn(
                    "text-xl font-bold uppercase tracking-[0.16em] sm:text-2xl",
                    riskAccent,
                  )}
                >
                  {verdict}
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            />
            <ResultStat label="Risk Level" value={result.final_risk} />
        ...
        <GlassCard className="overflow-hidden px-5 py-6 sm:px-8 sm:py-8">
          <div className="space-y-6">
            ...
            <div className="rounded-[1.75rem] border border-white/10 bg-[#0a1020]/88 p-5">
              ...
              <p className={cn("mt-3 text-xl font-semibold", riskAccent)}>
                {primaryValue}
              </p>
            </div>
            ...
            <div className="space-y-3">
              {result.urls_analyzed.length > 0 ? (
                ...
                <p className="rounded-[1.4rem] border border-dashed border-white/12 bg-white/4 px-4 py-5 text-sm text-slate-300">
                  No URLs were extracted from this analysis.
                </p>
              )}
            </div>
          </div>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <InsightList
          eyebrow="Reasons"
          title="Why this triggered the phishing verdict"
